					...
					<fieldset>
							...
							<div class="col-lg-10">
								<form:input path="scfu_fname" class="form-control"
									id="scfu_fname" placeholder="First Name" />
					             	...
					             	<form:errors path="scfu_fname" id="error01" class="validation" />
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								...
								<form:errors path="scfu_lname" id="error01" class="validation" />
							...
							<div class="col-lg-10">
								<form:input path="scfu_email" class="form-control"
									id="inputEmail" placeholder="Email" />
					             	<form:errors path="scfu_email" id="error01" class="validation" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
					            ...
					            <form:errors path="scfu_password" id="error01" class="validation" />
